        ...
        <div class="layui-col-md12">
            ...
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('setting/updateStation')); ?>" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">获取最新资讯二维码</label>
                        <?php echo $setting['news_wechat_image']->files('value')->field('news_wechat_image')
                        ->url($setting['news_wechat_image']->getUploadUrl('value'))
                        ->uploader(); ?>

                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">官网微信二维码</label>
                        <?php echo $setting['wechat_image']->files('value')->field('wechat_image')
                        ->url($setting['wechat_image']->getUploadUrl('value'))
                        ->uploader(); ?>
